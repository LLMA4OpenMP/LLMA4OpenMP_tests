...
/* rowstr[1:NA+1] */
static int rowstr[150002];
/* iv[1:2*NA+1] */
static int iv[300002];
/* arow[1:NZ] */
...
/* common /main_flt_mem/ */
/* v[1:NA+1] */
static double v[150002];
/* aelt[1:NZ] */
static double aelt[NZ + 1];
/* a[1:NZ] */
static double a[NZ + 1];
/* x[1:NA+2] */
static double x[150003];
/* z[1:NA+2] */
static double z[150003];
/* p[1:NA+2] */
static double p[150003];
/* q[1:NA+2] */
static double q[150003];
/* r[1:NA+2] */
static double r[150003];
...
//epsilon = 1.0e-2;
  ...
  c_print_results("CG",class,150000,0,0,75,nthreads,t,mflops,"          floating point",verified,"3.0 structured","14 Jan 2020","(none)","(none)","-lm","(none)","(none)","(none)","randdp");
}
/*--------------------------------------------------------------------
c-------------------------------------------------------------------*/
