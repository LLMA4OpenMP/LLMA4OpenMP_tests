...
#pragma omp parallel for
    ...
    for (i = 0; i < NUM_KEYS; i++)
    {
        ...
        // Cannot parallelize the following line safely due to potential race conditions:
        // Multiple threads could increment the same index of prv_buff1, leading to a data race.
