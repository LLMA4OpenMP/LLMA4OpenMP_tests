...
static void init_array(int n,double X[500][500],double A[500][500],double B[500][500])
{
//int i;
//int j;
{
...
static void print_array(int n,double X[500][500])
{
  int i;
  int j;
  #pragma omp parallel for
...
static void kernel_adi(int tsteps,int n,double X[500][500],double A[500][500],double B[500][500])
{
//int t;
//int i1;
//int i2;
...
/* Variable declaration/allocation. */
  double (*X)[500][500];
  X = ((double (*)[500][500])(polybench_alloc_data(((500 + 0) * (500 + 0)),(sizeof(double )))));
  ;
  double (*A)[500][500];
  A = ((double (*)[500][500])(polybench_alloc_data(((500 + 0) * (500 + 0)),(sizeof(double )))));
  ;
  double (*B)[500][500];
  B = ((double (*)[500][500])(polybench_alloc_data(((500 + 0) * (500 + 0)),(sizeof(double )))));
  ;
/* Initialize array(s). */
  init_array(n, *X, *A, *B);
/* Start timer. */
